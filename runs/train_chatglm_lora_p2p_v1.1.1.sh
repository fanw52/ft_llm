# 新增关系数据
# 在v1.0.0的基础上增加长尾3141数据,过滤没有关系的数据，并随机丢弃30%的关系类型，共6297条，但保留长尾关系数据
# 训练数据量
lora_rank=8
...
your_checkpopint_path="/data2/wufan/llm/experiments/p2p_relation_v1.1.1"  # 填入用来存储模型的路径
...
CUDA_VISIBLE_DEVICES=0 python \
    ...
    --do_train \
    --train_file $your_data_path/train_add_tail_do_sample.json \
