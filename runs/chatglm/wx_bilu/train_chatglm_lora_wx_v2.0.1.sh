...
your_checkpopint_path="/data/wufan/llm/experiments/wx_bilu_v2.0.1"  # 填入用来存储模型的路径
...
torchrun \
    ...
    --do_train \
    --train_file $your_data_path/train_aug_0529.json \
    --validation_file $your_data_path/val_aug_0529.json \
