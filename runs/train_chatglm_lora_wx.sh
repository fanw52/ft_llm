...
your_data_path="/data/wufan/data/wx_bilu"  # 填入数据集所在的文件夹路径
your_checkpopint_path="/data/wufan/llm/experiments/wx_bilu_v1.0.1/"  # 填入用来存储模型的路径

deepspeed_config_file=./configs/deepspeed_config_zero2_offload.json
source_prefix="请根据下面对话，预测可能继续提问的问题："
...
torchrun \
    ...
    --validation_file $your_data_path/val.json \
