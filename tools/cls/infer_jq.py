...
# in_dir = "/data/wqx/llm-experiments/data/jq_classify"
# out_dir = "/data/wufan/experiments/llm/chatglm2/cls_jq_v1.0.0"
#
# path = f"{in_dir}/valid_llm.json"
# outpath = f"{out_dir}/jq_valid.json"
