...
if __name__ == '__main__':
    ...
    for lora_index, lora_model_path in enumerate(lora_model_paths):
        ...
        first_weight = base_model.transformer.layers[0].attention.query_key_value.weight
    ...
    if output_type == 'huggingface':
        ...
        AutoModel.save_pretrained(base_model, output_dir)  # , state_dict=deloreanized_sd)
        ...
        n_layers = params_of_models["n_layers"]
        n_heads = params_of_models["n_heads"]
        dim = params_of_models["dim"]
